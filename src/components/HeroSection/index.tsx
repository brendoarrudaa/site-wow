      ...
      <div className="relative page-container py-24 md:py-32 lg:py-40 w-full">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-lg lg:text-xl text-secondary-foreground/90 leading-relaxed max-w-xl">
            Servidor brasileiro de WotLK 3.3.5a com scripts Blizzlike, rates equilibradas
            e uma comunidade que leva o jogo a sério. Sem atalhos. Sem pay-to-win.
          </p>
