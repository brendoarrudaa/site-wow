...
const Blog = ({ posts }: Props) => {
  ...
  return (
    <Layout>
      ...
      <PageHeader
        title="Blog"
        subtitle="Notícias, changelogs, guias e tudo que acontece no Azeroth Legacy."
      />
          ...
          {filtered.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filtered.map(post => (
                ...
                >
                  <div
                    className={`h-36 rounded-t-lg bg-linear-to-br ${post.coverColor} relative overflow-hidden`}
                  >
                    {post.image ? (
                      <img
                        src={post.image}
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <p className="text-sm text-muted-foreground mt-2.5 line-clamp-2 leading-relaxed flex-1">
                      {post.excerpt}
                    </p>
