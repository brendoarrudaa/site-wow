...
const PrivacyPolicy = () => {
  return (
    <Layout>
      ...
      <PageHeader
        title="Política de Privacidade"
        subtitle={`Como o ${siteConfig.name} trata suas informações. Última atualização: abril de 2025.`}
      />
        ...
        <div className="page-container max-w-3xl">
          <div className="card-fantasy p-6 md:p-10 space-y-8">
            <p className="text-muted-foreground">
              Ao acessar o site ou jogar no servidor <strong className="text-foreground">{siteConfig.name}</strong>,
              você concorda com os termos desta Política de Privacidade. Leia com atenção.
            </p>

            {sections.map((section) => (
              <div key={section.title}>
                <h2 className="text-lg font-serif font-bold text-foreground mb-2">{section.title}</h2>
